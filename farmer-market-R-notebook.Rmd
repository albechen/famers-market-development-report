...
ggplot(fm_yes_media, aes(x=media, y=Yes, fill=media)) + 
  geom_bar(stat = "identity") +
  ggtitle("Count of Farmers Makets Usage of Media Platforms") +
...
ggplot(media_no2020, aes(x=year_update, y=Percent_Yes, group=media)) +
  ...
  geom_point(aes(color=media)) +
  ggtitle("Percent of Famers Markets Using Media Platforms Through Years") +
  xlab("Year Updated") + 
...
ggplot(fm_pay, aes(x=payment, y=Yes, fill=payment)) + 
  geom_bar(stat = "identity") +
  ggtitle("Count of Farmers Makets Accepting Payment Types") +
  xlab("Payment Types") + 
  ylab("Count")
